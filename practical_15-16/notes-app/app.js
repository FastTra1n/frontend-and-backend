...
async function subscribeToPush() {
  ...
  try {
    ...
    const subscription = await registration.pushManager.subscribe({
      ...
      applicationServerKey: urlBase64ToUint8Array("BFcglAqei3kWS-z8qApa7pizzGaKr42od-ekX0ziKEGJuOfnESqqByXl7ljEYzbrjp_4MJFLAKIYm0ykv_XeV8I")
    });
...
function initNotes() {
  ...
  function loadNotes() {
    ...
    list.innerHTML = notes
      .map(
        (note) =>
          `<li class="card" style="margin bottom: 0.5rem; padding: 0.5rem;">${note.text}</li>`,
      )
      .join("");
  }
